...
contract Token {
    ...
    //0x91875612892jkjkj => 1200 (e.g.)
    //0x871ec3h8cd2sx => 25000 (e.g.)
    ...
    //define a variable public means we can read this outside of smart contract
    
    //private variable cannot be read outside of smart contract using API of euthereum
    //but since blockchain is public, if you run your own binance smartchain node and some security tools
